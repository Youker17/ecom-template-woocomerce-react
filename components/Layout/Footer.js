  ...
  return (
    <div className="bg-white-300 pt-10">
      ...
      <div className="flex flex-col visible lg:invisible w-screen lg:w-fit gap-1 mt-16">
        <p className="text-gray-400 ">©{new Date().getFullYear()} - Remacify</p>
        <p className="text-gray-400 text-sm flex flex-row gap-2"> powered by Shopify <img src="   https://cdn-icons-png.flaticon.com/512/5968/5968965.png " className="w-4 opacity-50 object-contain" alt="shopify" /></p>
      </div>
    </div>
  );
};
